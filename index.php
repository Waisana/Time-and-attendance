    ...
    <div class="left-right"> 
        ...
        <div class="section-right">
                    ...
                    <ul>
                        ...
                        <li class="attendance"> 
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    <a href="">Help</a>
                                    <a href="logout.php">Exit System</a>
                                </div>
                            </div> 
                        </li>
            ...
            <div class="detail-panels">
                <div class="heading">
                <h1>Smart Applications</h1>
                </div>
                <div class="parag">
                    <h3>Welcome to Smart Time and Attendance application</h3>
                </div>
                <div class="pannels">
                    <div class="panel-row-one">
                        <div class="boxii">
                            <a href="user.php">
                                <div class="box-one1 boxi">
                                    <div class="boxi-icon">
                                        <i class="ion-android-people icon-big"></i>
                                    </div>
                                    <div class="box-info1">
                                    <h3> Users</h3>
                                    </div>
                        ...
                        <div class="boxii">
                            <a href="dptment.php">
                                <div class="box-two2 boxi">
                                    <div class="boxi-icon">
                                        <i class="ion-android-options icon-big"></i>
                                    </div>
                                    <div class="box-info1">
                    ...
                    <div class="panel-row-two">
                        <div class="boxii">
                            <a href="#" id="da_report">
                                <div class="box-one1 boxi "> 
                                    <div class="boxi-icon">
                                        <i class="ion-document-text icon-big"></i>
                                    </div>
                                    <div class="box-info1">
                                    <h3>Reports</h3>
                                    </div>
                        ...
                        <div class="boxii">
                            <a href="#" id="admin_modal2">
                                <div class="box-two2 boxi ">
                                    <div class="boxi-icon">
                                        <i class="ion-android-contact icon-big"></i>
                                    </div>
                                    <div class="box-info1">
                                        <h3>Administrator</h3>
                                    </div>
