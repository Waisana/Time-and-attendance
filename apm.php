...
<body>
    <div class="left-right"> 
        ...
        <div class="section-right">
            ...
            <!-- attendance photo management area -->
            <div class="attendance_photo">
                <div class="button-all">
                    
                    <div class="thebtn_anyway">
                        <div class="button-one btn-select to_style_but">
                            <button>Select All</button>
                        </div>

                        <div class="button-two btn-select to_style_but">
                            <button>Download</button>
                        </div>
                    </div>
                    <div class="inside-photo-styling">
                        <div class="inside_thebtn_anyway">
                            <div class="button-three btn-select1 to_style_but">
                                <button>Change Photo</button>
                            </div>
                
                            <div class="button-four btn-select1 to_style_but">
                            ...
                            <div class="content table-responsive table-full-width">
                                <table>
                                    <thead> 
                                        ...
                                        <th rowspan="2"> <b>Device Name</b></th>
                                        <th rowspan="2"> <b>Attendance Time</b></th>
                                        <th rowspan="2"> <b>Status</b></th>
                                        <th colspan="2"> <b>Photo Count</b></th>
                                        <tr>
                                            <td><b>Pass</b></td>
                                            <td><b>Fail</b></td>
                                        </tr>
            ...
            <!-- End of attendance photo management -->
